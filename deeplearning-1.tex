...
(0).
\begin{figure}[H]
\center{\includegraphics[width=.6\textwidth]{1111.png}}
\caption{二分分类}
\label{fig:1111}
\end{figure}
\subparagraph{}
...
\begin{figure}[H]
\center{\includegraphics[width=.2\textwidth]{1112.png}}
\caption{特征向量}
\label{fig:1112}
\end{figure}
\subparagraph{}
...
$y\in{\{{}0,1\}{}}$ : 标签y= 0 or 1
\begin{figure}[H]
\center{\includegraphics[width=.8\textwidth]{1113.png}}
\caption{符号语法}
\label{fig:1113}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[width=.6\textwidth]{1114.png}}
\label{fig:1114}
\end{figure}
\subparagraph{}
The parameters used in Logistic regression are:
\begin{figure}[H]
\center{\includegraphics[width=.6\textwidth]{1115.png}}
\label{fig:1115}
\end{figure}
\begin{figure}[H]
\center{\includegraphics[width=.6\textwidth]{1116.png}}
\caption{逻辑函数sigmoid}
\label{fig:1116}
\end{figure}
\subparagraph{}
